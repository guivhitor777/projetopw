...
<!-- SideNavBar -->
<aside class="fixed left-0 top-0 h-full w-sidebar-width bg-surface/40 backdrop-blur-xl border-r border-white/10 flex flex-col py-gutter px-4 z-50">
...
<a class="flex items-center gap-4 px-4 py-3 rounded-lg text-on-surface-variant hover:bg-white/5 transition-colors scale-95 active:scale-90 transition-transform" href="#">
...
<a class="relative flex items-center gap-4 px-4 py-3 rounded-lg text-primary bg-primary/10 border-l-2 border-primary scale-95 active:scale-90 transition-transform" href="#">
...
<a class="flex items-center gap-4 px-4 py-3 rounded-lg text-on-surface-variant hover:bg-white/5 transition-colors" href="#">
...
<!-- TopNavBar -->
<header class="fixed top-0 right-0 w-[calc(100%-var(--sidebar-width))] h-16 bg-surface/30 backdrop-blur-lg border-b border-white/5 flex justify-between items-center px-container-padding-desktop z-40">
...
<input class="bg-transparent border-none focus:ring-0 text-body-md w-full placeholder:text-on-surface-variant/50" placeholder="Search academic records..." type="text"/>
</div>
...
<img alt="Student Profile" class="w-full h-full rounded-full object-cover" data-alt="A close-up portrait of a young male student with a focused and intelligent expression. The lighting is soft and cinematic, using cool blue tones to match a futuristic educational interface. He is set against a dark, minimalist background that feels like a high-tech academic environment. The overall aesthetic is professional, clean, and visionary." src="https://lh3.googleusercontent.com/aida-public/AB6AXuCjWGrAQs4HbYkMLj1ibPKmAlTQ0TFFCsWVOTtNFuFDuJ3N9seiNWdQxKQq6YlH2Anbf4VoaDM7-4woGtQ7QRe6omDTu7X5WCbbs51R2Q5ehDZZTEqZLhXW6dlo0THUVBMLnj2FmnYMZ4dcWmAYwg6JZfH9ZG7d9By7uawz5YZbrgorOGDgxfs9DJ30bUG5FwifPZlWq8mF3sqmDcuo1N0856Du1m-5q-RXpnvBXBfbLE16sh8D15EqW5QQya5XKslx6iqLUfDmlARn"/>
</div>
</div>
</div>
</header>
...
<div class="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] bg-primary/5 blur-[120px] rounded-full pointer-events-none"></div>
<div class="absolute bottom-[-10%] left-[5%] w-[400px] h-[400px] bg-tertiary/5 blur-[100px] rounded-full pointer-events-none"></div>
...
<span class="font-label-caps text-[11px] hover:text-primary cursor-pointer transition-colors">DASHBOARD</span>
<span class="material-symbols-outlined text-[14px]">chevron_right</span>
<span class="font-label-caps text-[11px] hover:text-primary cursor-pointer transition-colors">GRADES</span>
<span class="material-symbols-outlined text-[14px]">chevron_right</span>
...
<p class="font-body-md text-on-surface-variant max-w-2xl">Modify academic performance records for the current semester. Changes will be synchronized across the distributed ledger system.</p>
</header>
<!-- Centered Form Card -->
...
<select class="w-full bg-surface-container-lowest border border-white/10 rounded-lg px-4 py-3 text-body-md text-on-surface appearance-none focus:outline-none focus:border-primary/50 transition-all neon-glow">
...
<div class="relative">
<input class="w-full bg-surface-container-lowest border border-white/10 rounded-lg px-4 py-3 text-body-md text-on-surface focus:outline-none focus:border-primary/50 transition-all neon-glow placeholder:text-on-surface-variant/30" placeholder="e.g. 9.5 or A+" type="text"/>
...
<div class="h-[50px] flex items-center px-4 bg-primary/5 border border-primary/20 rounded-lg text-primary font-label-caps text-[13px] tracking-wider">
<span class="material-symbols-outlined text-[18px] mr-2" style="font-variation-settings: 'FILL' 1;">bolt</span>
...
<textarea class="w-full bg-surface-container-lowest border border-white/10 rounded-lg px-4 py-3 text-body-md text-on-surface focus:outline-none focus:border-primary/50 transition-all neon-glow placeholder:text-on-surface-variant/30 resize-none" placeholder="Document specific achievements, mitigating circumstances, or faculty remarks..." rows="5"></textarea>
</div>
<!-- Action Buttons -->
<div class="flex items-center justify-end gap-4 pt-6">
<button class="px-8 py-3 rounded-lg font-label-caps text-label-caps text-on-surface-variant border border-white/10 hover:bg-white/5 transition-all active:scale-95" type="button">
                            Cancelar
                        </button>
<button class="group relative px-10 py-3 rounded-lg font-label-caps text-label-caps bg-primary text-on-primary-container overflow-hidden transition-all hover:shadow-[0_0_20px_rgba(173,198,255,0.4)] active:scale-95" type="submit">
...
<div class="p-4 rounded-lg bg-surface-container-high/50 border border-white/5">
<p class="font-label-caps text-[10px] text-on-surface-variant/50 mb-2 uppercase">System Integrity</p>
